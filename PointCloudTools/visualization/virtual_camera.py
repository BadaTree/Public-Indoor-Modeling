...
# 파일 경로 및 이름 설정
output_dir = r"C:/Users/SKH/Github_local/3d/PointCloudTools/data/"  # 동영상 저장 디렉토리 설정
ply_filename = "poly.glb"  # 읽어들일 .ply 파일명 설정

output_center_filename = "point_cloud.mp4"  # 동영상 파일 이름 설정
output_line_filename = "demo-line11.mp4"  # 동영상 파일 이름 설정
